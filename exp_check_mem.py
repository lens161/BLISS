...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        for rm in reass_modes:
            configs_b.append(Config(dataset_name=dataset, batch_size=1024, b=8192, reass_mode=rm, reass_chunk_size=40_000, mem_tracking=True, datasize=10, r=2, epochs=2, iterations=2))
        # for m in m_values:
            # configs_q.append(Config(dataset_name=dataset, batch_size=1024, b=16384, m=m, reass_mode=0, reass_chunk_size=40_000, mem_tracking=True, datasize=100))
